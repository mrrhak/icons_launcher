...
void main() {
  ...
  test('Correct number of android icons launcher', () {
    expect(android.androidIcons.length, 5);
  });

  test('Config contains string for generating new icons launcher', () {
  ...
  test('Transforming manifest without icon must add icon', () async {
    ...
    await withTempFile('AndroidManifest.xml', (File androidManifestFile) async {
      ...
      await android.overwriteAndroidManifestWithNewIconLauncher(
