...
void createLinuxIcons({required String imagePath}) {
  ...
  if (!snapcraftFile.existsSync()) {
    ...
    CliLogger.success('Created snapcraft file', level: CliLoggerLevel.two);
  } else {
    CliLogger.warning('Snapcraft file already exists',
        level: CliLoggerLevel.two);
  }
  ...
  if (!desktopFile.existsSync()) {
    ...
    CliLogger.warning('Desktop entry file already exists',
        level: CliLoggerLevel.two);
  }
}
